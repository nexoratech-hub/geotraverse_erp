...
try {
    ...
    // STEP 1: ALWAYS create a NEW conversation - don't reuse old ones
    // This ensures fresh start after delete
    $insert_conv = "
    ...
    // STEP 2: Insert the message into the NEW conversation
    $insert_msg = "
    ...
    $msg_stmt->bind_param("iiiiss", $sender_dept, $receiver_dept, $new_conversation_id, $sender_dept, $receiver_dept, $message);
    $msg_stmt->execute();
